  ...
  useEffect(() => {
    ...
    if (!savedVideos) {
      ...
      const defaultVideos = [
        ...
        // Events & Nightlife videos (p2-p6.mp4)
      ...
      console.log('Default videos initialized in localStorage with paths:', defaultVideos.map(v => v.videoUrl));
    } else {
    ...
    const testVideoLoad = () => {
      ...
      testVideo.src = '/modelling/1.mp4';
      testVideo.onloadedmetadata = () => {
        console.log('✅ Video loading successful - videos are accessible');
      };
      testVideo.onerror = (error) => {
        console.error('❌ Video loading failed:', error);
        console.log('Make sure video files exist in /public/modelling/ directory');
      };
    };
